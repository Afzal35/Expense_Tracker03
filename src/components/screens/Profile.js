...
const Profile = () => {
    ...
    const profileHandler = (e) => {
        e.preventDefault();
        const url = "https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyDQ41Z0k9Rbm84CFgvcZ73ay90sYutzKcA";
    ...
    useEffect(() => {
        const profileUrl = "https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyDQ41Z0k9Rbm84CFgvcZ73ay90sYutzKcA";
        fetch(profileUrl, {
            method: "POST",
            body: JSON.stringify({
                idToken: idToken
    ...
    const verifyHandler = (e) => {
        e.preventDefault();
        fetch("https://identitytoolkit.googleapis.com/v1/accounts:sendOobCode?key=AIzaSyDQ41Z0k9Rbm84CFgvcZ73ay90sYutzKcA", {
            method: "POST",
            body: JSON.stringify({
